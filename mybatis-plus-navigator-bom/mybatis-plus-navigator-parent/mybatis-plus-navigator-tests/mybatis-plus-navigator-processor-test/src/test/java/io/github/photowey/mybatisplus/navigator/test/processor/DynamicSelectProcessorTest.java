...
import io.github.photowey.mybatisplus.navigator.test.core.query.EmployeeDynamicSelectQuery;
...
/**
 * {@code DynamicSelectProcessorTest}
 *
 * @author photowey
 * @version 3.5.5.1.0
 * @since 2024/05/09
...
class DynamicSelectProcessorTest extends LocalTest {
    ...
    void testDynamicSelect() {
        EmployeeDynamicSelectQuery query = EmployeeDynamicSelectQuery.builder()
                .id(1713369638000L)
                .properties(Arrays.asList("id", "organization_id"))
                .build();
        ...
        Assertions.assertEquals("id,organization_id", sqlSelect);
    }
}