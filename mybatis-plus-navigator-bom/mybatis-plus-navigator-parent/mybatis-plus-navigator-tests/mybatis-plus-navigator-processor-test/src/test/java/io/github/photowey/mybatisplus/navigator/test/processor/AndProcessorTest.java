...
@SpringBootTest(classes = {
        App.class,
        AndProcessorTest.ConditionHandleConfigure.class,
})
class AndProcessorTest extends LocalTest {
