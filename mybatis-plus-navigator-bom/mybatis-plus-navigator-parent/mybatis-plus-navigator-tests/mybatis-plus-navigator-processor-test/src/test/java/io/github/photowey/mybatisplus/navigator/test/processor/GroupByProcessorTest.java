...
import io.github.photowey.mybatisplus.navigator.test.core.query.EmployeeGroupByQuery;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import org.springframework.boot.test.context.SpringBootTest;

/**
 * {@code GroupByProcessorTest}
 *
 * @author photowey
 * @version 3.5.5.1.0
 * @since 2024/05/07
...
class GroupByProcessorTest extends LocalTest {
    ...
    @Test
    void testGroupBy() {
        EmployeeGroupByQuery query = EmployeeGroupByQuery.builder()
                .organizationId(9527L)
                .build();

        QueryWrapper<Employee> wrapper = query.tryVisitQueryWrapper();
        String targetSql = wrapper.getTargetSql();
        Assertions.assertEquals(" GROUP BY organization_id", targetSql);
    }
}