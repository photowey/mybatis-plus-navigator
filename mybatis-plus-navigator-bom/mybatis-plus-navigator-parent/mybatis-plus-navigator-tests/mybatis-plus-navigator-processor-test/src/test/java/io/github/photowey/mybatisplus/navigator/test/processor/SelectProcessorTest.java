...
import io.github.photowey.mybatisplus.navigator.test.core.query.EmployeeSelectQuery;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import org.springframework.boot.test.context.SpringBootTest;

/**
 * {@code SelectProcessorTest}
 *
 * @author photowey
 * @version 3.5.5.1.0
 * @since 2024/05/09
...
class SelectProcessorTest extends LocalTest {
    ...
    @Test
    void testSelect() {
        EmployeeSelectQuery query = EmployeeSelectQuery.builder()
                .id(1713369638000L)
                .build();
