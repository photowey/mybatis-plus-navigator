...
/**
 * {@code EmployeeMultiOrderByDynamicQuery}
 *
 * @author photowey
 * @version 3.5.5.1.0
 * @since 2024/05/21
...
public class EmployeeMultiOrderByDynamicQuery extends AbstractQuery<Employee> implements Serializable {
    ...
    @MultiOrderBy(order = SortingOrder.DESC, mechanism = SortingMechanism.DYNAMIC)
