...
public class EmployeeMultiExistQuery extends AbstractQuery<Employee> implements Serializable {
    ...
    @Exists(existsSql = "SELECT id FROM employee WHERE employee_no = {0} AND status = {1}")
