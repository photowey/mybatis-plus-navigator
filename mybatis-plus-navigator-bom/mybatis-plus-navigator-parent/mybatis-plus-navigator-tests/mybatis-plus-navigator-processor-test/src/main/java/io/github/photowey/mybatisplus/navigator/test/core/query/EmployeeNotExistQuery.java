...
public class EmployeeNotExistQuery extends AbstractQuery<Employee> implements Serializable {
    ...
    @NotExists(existsSql = "SELECT id FROM employee WHERE organization_id = {0}")
