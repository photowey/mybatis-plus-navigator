...
public class EmployeeConditionQuery extends AbstractQuery<Employee> implements Serializable {
    ...
    @And(handler = "io.github.photowey.mybatisplus.navigator.test.processor.EmployeeAndQueryHandler")
    private Long organizationId;

    @Or(handler = "io.github.photowey.mybatisplus.navigator.test.processor.EmployeeAndQueryHandler")
